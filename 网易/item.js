      ...
      , q = l.BufferedBlockAlgorithm = t.extend({
        ...
        mG4K: function(a) {
            var c = this.i1x
              ...
              , k = this.blockSize
              , b = j / (4 * k)
              , b = a ? u.ceil(b) : u.max((b | 0) - this.Rm3x, 0);
            a = b * k;
            j = u.min(4 * a, j);
            if (a) {
                for (var q = 0; q < a; q += k)
    ...
    var p = CryptoJS
      ...
      , v = d.Cipher = t.extend({
        ...
        createEncryptor: function(e, a) {
            return this.create(this.GC8u, e, a)
        },
        createDecryptor: function(e, a) {
            return this.create(this.buY1x, e, a)
        },
        init: function(e, a, b) {
...
(function() {
    ...
    var H = [0, 1, 2, 4, 8, 16, 32, 64, 128, 27, 54]
      , d = d.AES = p.extend({
        mq4u: function() {
            for (var a = this.J1x, c = a.words, d = a.sigBytes / 4, a = 4 * ((this.YX5c = d + 6) + 1), e = this.bvc1x = [], j = 0; j < a; j++)
                if (j < d)
                    e[j] = c[j];
                else {
                    var k = e[j - 1];
        ...
        encryptBlock: function(a, b) {
            this.CL7E(a, b, this.bvc1x, t, r, w, v, l)
        },
        decryptBlock: function(a, c) {
            var d = a[c + 1];
            a[c + 1] = a[c + 3];
            a[c + 3] = d;
            this.CL7E(a, c, this.bvi1x, b, x, q, n, s);
            d = a[c + 1];
            a[c + 1] = a[c + 3];
            a[c + 3] = d
        },
        CL7E: function(a, b, c, d, e, j, l, f) {
            for (var m = this.YX5c, g = a[b] ^ c[0], h = a[b + 1] ^ c[1], k = a[b + 2] ^ c[2], n = a[b + 3] ^ c[3], p = 4, r = 1; r < m; r++)
...
function getMusicLyricEnc( params ) {

    a1 = JSON.stringify( params );
    a2 = '010001';
    a3 = '';
    a4 = '0CoJUm6Qyw8W8jud';
